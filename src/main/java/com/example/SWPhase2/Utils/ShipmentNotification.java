...
public class ShipmentNotification extends Notification{
    ...
    public ShipmentNotification(String subject, ChannelType[] channelType, String[] availableLanguage, Order order, Database db) {
    ...
    public String getMessage() {
        ...
        return String.format("Dear %s, your shipment of the item(s) %s is delivered, thanks for using our store :)", customer.getUsername(), allItems);
    }
}